...
namespace DeltaDNA
{
    public class Settings
    {
        ...
        internal Settings()
        {
            ...
            OnPauseSendGameEndedStartedEvent = true;
            OnDestroySendGameEndedEvent = true;
        ...
        /// <summary>
        /// Controls whether a 'gameEnded' event is sent when the game is backgrounded, and a 'gameStarted' event when the game is resumed.
        /// </summary>
        public bool OnPauseSendGameEndedStartedEvent { get; set; }

        /// <summary>
        /// Controls whether a 'gameEnded' event is sent after the OnDestroy call.
        /// </summary>
